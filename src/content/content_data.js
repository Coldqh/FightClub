  ...
  weeklyEvents: [
    {
      ...
      effect: function (fighter) {
        var amount = rand(20, 45);
        fighter.money += amount;
        return { money: amount };
      },
      text: function (result) {
        return "Случайный калым помог пережить неделю спокойнее. +$" + result.money + ".";
      },
      tone: "good"
    },
    {
      ...
      text: function () {
        return "Напряжение вокруг боев растет. Голова снова гудит.";
      },
      tone: "bad"
    },
    {
      ...
      effect: function (fighter) {
        fighter.health -= 8;
        fighter.stress += 5;
        return { health: -8, stress: 5 };
      },
      text: function () {
        return "Старая боль напоминает о себе и тормозит подготовку.";
      },
      tone: "bad"
    },
    {
      ...
      text: function () {
        return "Район снова говорит о тебе. Известность подросла.";
      },
      tone: "good"
    },
    {
      ...
      condition: function () { return true; },
      effect: function (fighter) {
        fighter.skillPoints += 5;
        return { skillPoints: 5 };
      },
      text: function () {
        return "Тренер докрутил мелочи. +5 очков навыков.";
      },
      tone: "good"
    }
  ]
