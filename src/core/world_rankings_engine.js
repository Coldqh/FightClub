var WorldRankingsEngine = (function () {
  ...
  function streetStandingValue(fighter) {
    if (!fighter || !fighter.streetData) {
      return 9999;
    }
    if (fighter.streetData.nationalStreetStanding > 0) {
      return fighter.streetData.nationalStreetStanding;
    }
    return 9999;
  }
